...
#define LOG4CPLUS_MACRO_FATAL_LOG_LEVEL(pred) \
    LOG4CPLUS_LIKELY (pred)
#define LOG4CPLUS_MACRO_ALWAYS_LOG_LEVEL(pred) \
    LOG4CPLUS_LIKELY (pred)
...
// always log macro
#if !defined(LOG4CPLUS_DISABLE_ALWAYS)
#define LOG4CPLUS_ALWAYS(logger, logEvent)                               \
    LOG4CPLUS_MACRO_BODY (logger, logEvent, ALWAYS_LOG_LEVEL)
#define LOG4CPLUS_ALWAYS_STR(logger, logEvent)                           \
    LOG4CPLUS_MACRO_STR_BODY (logger, logEvent, ALWAYS_LOG_LEVEL)

#if defined (LOG4CPLUS_HAVE_C99_VARIADIC_MACROS)
#define LOG4CPLUS_ALWAYS_FMT(logger, ...)                                \
    LOG4CPLUS_MACRO_FMT_BODY (logger, ALWAYS_LOG_LEVEL, __VA_ARGS__)
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_ALWAYS_FMT(logger, logArgs...)                         \
    LOG4CPLUS_MACRO_FMT_BODY(logger, ALWAYS_LOG_LEVEL, logArgs)
#endif

#else
#define LOG4CPLUS_ALWAYS(logger, logEvent) LOG4CPLUS_DOWHILE_NOTHING()
#define LOG4CPLUS_ALWAYS_STR(logger, logEvent) LOG4CPLUS_DOWHILE_NOTHING()
#if defined (LOG4CPLUS_HAVE_C99_VARIADIC_MACROS)
#define LOG4CPLUS_ALWAYS_FMT(logger, ...) LOG4CPLUS_DOWHILE_NOTHING()
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_ALWAYS_FMT(logger, logArgs...) LOG4CPLUS_DOWHILE_NOTHING()
#endif
