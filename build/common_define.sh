...
LIBUDT_SRC_DIR=${ARCHIVES_DIR}/${LIBUDT_BASENAME}
...
LIBRTMP_SRC_DIR=${ARCHIVES_DIR}/${LIBRTMP_BASENAME}
...
LIBUDT_INSTALL_DIR=${THIRD_PARTY_INSTALL_PREFIX}/libudt
...
LIBRTMP_INSTALL_DIR=${THIRD_PARTY_INSTALL_PREFIX}/librtmp
...
function UnzipAll
{
    ...
    tar -C ${ARCHIVES_DIR} -xvf ${ARCHIVES_DIR}/${LIBUDT_BASENAME}.tar.gz
    if [ $? -ne 0 ]; then
        echo "failed to unzip" ${ARCHIVES_DIR}/${LIBUDT_BASENAME}.tar.gz
        exit 1
    fi
    ...
    tar -C ${ARCHIVES_DIR} -xvf ${ARCHIVES_DIR}/${LIBRTMP_BASENAME}.tar.gz
    if [ $? -ne 0 ]; then
        echo "failed to unzip" ${ARCHIVES_DIR}/${LIBRTMP_BASENAME}.tar.gz
        exit 1
    fi
